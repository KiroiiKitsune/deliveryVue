      ...
      <div class="products-wrapper">
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assests/image/goods/good-1.jpg" alt="good-1" />
          </div>
            ...
            <div class="products-card__description-row">
              <div class="products-card__description-controls">
                <button class="btn btn-primary">
                  В корзину
                  <img
                    src="../assests/image/icons/shoping-card-white.svg"
                    alt="shoping-card"
                  />
                </button>
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assests/image/goods/good-2.jpg" alt="good-2" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assests/image/goods/good-3.jpg" alt="good-3" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assests/image/goods/good-4.jpg" alt="good-4" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assests/image/goods/good-5.jpg" alt="good-5" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">
        ...
        <div class="products-card">
          <div class="products-card__image">
            <img src="../assests/image/goods/good-6.jpg" alt="good-6" />
          </div>
          <div class="products-card__description">
            <div class="products-card__description-row">
              <h5 class="products-card__description--name">
